Module Runtime
    ...
    Sub Main()
        ...
        Try
            ...
            mywriter.WriteLine()
            Dim tface As Integer = Csv.Convert(objfile, mywriter)
            mywriter.Close()
            Console.WriteLine(StringResource.ExportFinished, objfile.MaterialLib.Materials.Count, tface, rface - tface)
            If rface > tface Then
                Console.WriteLine()
            End If
